...
abstract class ConvertToTyUsingTryTraitAndUnpackFix(
    ...
    override fun addFromCall(rsPsiFactory: RsPsiFactory, startElement: RsExpr, fromCall: RsExpr) {
        ...
        when {
            parentFnRetTy != null && isFnRetTyResultAndMatchErrTy(startElement, parentFnRetTy, errTy) ->
...
fun isFnRetTyResultAndMatchErrTy(element: RsExpr, fnRetTy: Ty, errTy: Ty): Boolean {
    ...
    return fnRetTy is TyAdt && fnRetTy.item == items.findResultItem()
        && lookup.canSelect(TraitRef(fnRetTy.typeArguments.get(1), (items.findFromTrait()
